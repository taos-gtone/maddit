...
public class HomeController {
    ...
    public String home(Model model) {
        ...
        popularList.add(makeProg(6, "ClipBoard++",   "클립보드 히스토리 관리 및 자동 붙여넣기",       "생산성",  "📋", "linear-gradient(135deg,#4facfe,#00f2fe)", 5601, "DevUtils",       "3일 전",  "N"));
        popularList.add(makeProg(7, "PassVault",     "로컬 암호화 기반 비밀번호 관리자",             "보안",   "🔐", "linear-gradient(135deg,#2c3e50,#4ca1af)", 4330, "SecureSoft",     "1주 전",  "N"));
        popularList.add(makeProg(8, "FileOrganizer", "폴더 구조를 자동으로 정리해주는 유틸리티",       "파일관리", "🗂️", "linear-gradient(135deg,#11998e,#38ef7d)", 3820, "FileMaster",     "5일 전",  "N"));
        popularList.add(makeProg(9, "FocusTimer",    "포모도로 기반 집중 타이머 + 통계 트래킹",       "생산성",  "⏱️", "linear-gradient(135deg,#f7971e,#ffd200)", 2110, "ProductivityHub","2주 전",  "N"));
        popularList.add(makeProg(10,"DataViz Pro",   "엑셀 데이터를 한 번에 시각화해주는 데스크톱 앱",  "데이터",  "📊", "linear-gradient(135deg,#667eea,#764ba2)", 1240, "DataLab Studio", "1일 전",  "N"));
