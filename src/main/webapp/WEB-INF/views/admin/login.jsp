...
<div class="adm-login-wrap">
  <div class="adm-login-box">
    ...
    <div class="adm-login-logo">
      <div class="adm-login-logo-icon">🛡️</div>
      <div class="adm-login-logo-title">Maddit</div>
    ...
    <div class="adm-login-card">
      ...
      <form method="post" action="/maddit/admin/login" onsubmit="return validateForm()">
    ...
    <div class="adm-security-badge">🔒 관리자 전용 보호 구역 · 허가된 인원만 접근 가능</div>
  </div>
</div>
