    ...
    <div class="content-inner">
      ...
      <div class="board-header">
        <div class="board-header-left">
          <h1 class="board-title">✏️ 글쓰기</h1>
        </div>
      </div>

      <!-- 글쓰기 폼 -->
      <div class="write-card">
        <form class="write-form" action="<%= contextPath %>/board/free/write" method="post"
          ...
          <div class="write-actions">
            <a href="<%= contextPath %>/board/free" class="btn-cancel">취소</a>
      ...
      <div class="write-bottom-list">
          ...
          <table class="board-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="col-title">
                  <a class="post-title-link" href="<%= contextPath %>/board/free/view/<%= post.getPostNo() %>">
        ...
        <nav class="board-pagination">
          ...
          <% } else { %>
            <a href="<%= contextPath %>/board/free/write?page=<%= currentPage - 1 %>" class="pg-btn">‹</a>
          <% } %>

          <% if (startPage > 1) { %>
            <a href="<%= contextPath %>/board/free/write?page=1" class="pg-btn">1</a>
          ...
          <% for (int i = startPage; i <= endPage; i++) { %>
            ...
            <% } else { %>
              <a href="<%= contextPath %>/board/free/write?page=<%= i %>" class="pg-btn"><%= i %></a>
            <% } %>
          <% } %>

          <% if (endPage < totalPages) { %>
            <% if (endPage < totalPages - 1) { %><span class="pg-ellipsis">···</span><% } %>
            <a href="<%= contextPath %>/board/free/write?page=<%= totalPages %>" class="pg-btn"><%= totalPages %></a>
          <% } %>
