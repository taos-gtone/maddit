...
public class BoardController {
    ...
    private static final String BOARD_GBN_CD     = "03";
    ...
    public String writeForm(@RequestParam(defaultValue = "1") int page,
        ...
        if (memberNo == 0) return "redirect:/member/login?redirect=/board/request/write";
    ...
    public String view(@PathVariable long postNo,
        ...
        if (post == null) return "redirect:/board/request";
    ...
    public String editForm(@PathVariable long postNo,
        ...
        HttpSession session = request.getSession(false);
        long memberNo = getLoginMemberNo(session);
        if (memberNo == 0) return "redirect:/member/login?redirect=/board/request/edit/" + postNo;

        BoardPostVO post = boardService.getPost(postNo);
        if (post == null || post.getMemberNo() != memberNo) return "redirect:/board/request";
    ...
    public String edit(@PathVariable long postNo,
        ...
        return "redirect:/board/request/view/" + postNo;
    }
